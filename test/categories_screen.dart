...
class _CategoriesScreenState extends State<CategoriesScreen> {
  ...
  Widget _buildSection(ThemeData theme, String label, List<Category> cats) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
            ...
            confirmDismiss: (_) async =>
                await showDialog<bool>(
                  ...
                  builder: (ctx) => AlertDialog(
                    ...
                    content: const Text(
                      'Existing transactions with this category will keep their label.',
                    ),
                    actions: [
                      TextButton(
            ...
            child: Container(
              ...
              child: ListTile(
                ...
                trailing: IconButton(
                  ...
                  onPressed: () => _addCategoryDialog(existing: c),
                ),
              ),
            ),
          ),
